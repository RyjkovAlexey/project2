...
import ru.alexey.springcourse.Project2Boot.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public List<Book> getBooksByPersonId(int id) {
        ...
        long MILLISECONDS_IN_10_DAYS = 864000000L;
        ...
        if (person.isPresent()) {
            ...
            person.get().getBooks().forEach(book -> {
                ...
                if (diffInMilliseconds > MILLISECONDS_IN_10_DAYS) {
